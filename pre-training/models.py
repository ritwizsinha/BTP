...
def initialize_model():
    """ Initializes theno CUDA-capable device is detected at /opt/conda/conda-bld/pytorch_1573049301898/work/aten/src/THC/THCGeneral.cpp:50 model to be trained. Possible model: "GGNN".
    ...
    net = net.to("cpu", non_blocking=True)
