...
jobname = "8-4-22"      # used to create a sub directory
...
# set paths here
env_name="RL-GraphINVENT-env"
python_path = f"/anaconda/envs/{env_name}/bin/python"
graphinvent_path = f"pre-training/"
data_path = f"data/pre-training/"

# define dataset-specific parameters
params = {
    "atom_types": ['B', 'C', 'N', 'O', 'F', 'Si', 'P', 'S', 'Cl', 'Mn', 'Co', 'Cu', 'Br', 'I'],
    "formal_charge": [-1, 0, +1],
    "max_n_nodes": 152,
    "job_type": job_type,
    ...
    "batch_size": 1000,
    "block_size": 100000,
    "generation_epoch": 30, #['None'] + [a for a in range(5, 201, 5)],  # <-- which model to use (i.e. which epoch) must be a number for "generate" and a list for "multiple_valid" and "valid_loss"
    "n_samples": 10000,       # <-- how many structures to generate
