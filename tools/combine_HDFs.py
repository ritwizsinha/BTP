...
# set variables
dataset = "anti-sars"
n_dirs = 54         # how many times was `train.smi` split?
n_atom_types = 14     # number of atom types used in preprocessing the data
...
max_n_nodes = 152     # maximum number of nodes in the data
not_include = [14, 18, 19, 27, 45, 48, 53]
# automatically generate a list of the HDF paths
path_list = [f"data/pre-training/anti-sars-{i}/train.h5" for i in range(0, n_dirs) if i not in not_include] 
...
def main(path_list):
    ...
    csv_list = [f"data/pre-training/anti-sars-{i}/train.csv" for i in range(0, n_dirs) if i not in not_include]
